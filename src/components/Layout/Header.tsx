...
/**
 * Функциональный компонент, представляющий шапку сайта с навигационными кнопками, а аткже кнопками вхоад, выхода и регитсрации
 * @param {HeaderProps} props - содержит только onMenuItemClick, совершаемое по клику действие
 * @returns 
 */
